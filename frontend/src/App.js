...
const SocialMediaIcons = {
  ...
  Twitter: () => (
    <svg viewBox="0 0 24 24" className="social-icon">
      ...
      <path fill="white" d="M18.244 7.234c.008.165.008.33.008.495 0 5.04-3.831 10.85-10.85 10.85A10.77 10.77 0 011.55 16.79a7.8 7.8 0 00.908.053 7.64 7.64 0 004.734-1.63 3.82 3.82 0 01-3.568-2.647 3.8 3.8 0 001.723-.066 3.816 3.816 0 01-3.06-3.742v-.049c.52.29 1.114.466 1.746.487a3.816 3.816 0 01-1.18-5.094A10.83 10.83 0 009.726 9.98a3.815 3.815 0 016.5-3.478 7.65 7.65 0 002.422-.924 3.83 3.83 0 01-1.677 2.11 7.61 7.61 0 002.19-.6 8.21 8.21 0 01-1.917 1.976z"/>
    </svg>
  ),
  LinkedIn: () => (
    <svg viewBox="0 0 24 24" className="social-icon">
