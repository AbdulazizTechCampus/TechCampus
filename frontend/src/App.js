...
const SocialMediaIcons = {
  ...
  Snapchat: () => (
    <svg viewBox="0 0 24 24" className="social-icon">
      ...
      <path fill="white" d="M12.166 3c3.47 0 6.334 2.693 6.334 6.037 0 1.102-.343 2.135-.933 3.007l.933 2.956-3.065-.93c-.896.572-1.962.93-3.269.93-3.47 0-6.333-2.693-6.333-6.037S8.696 3 12.166 3zm-.093 2.548c-.896 0-1.726.388-2.269 1.061-.543.673-.69 1.58-.404 2.476.286.896.977 1.631 1.889 2.007.912.376 1.932.267 2.789-.298l.857 1.289-1.714-1.051c-.557.179-1.138.18-1.695.004-1.113-.352-1.989-1.177-2.4-2.261-.411-1.084-.25-2.277.441-3.264C9.456 4.478 10.39 3.847 11.488 3.642c1.098-.205 2.227.073 3.09.762l-1.285 1.62c-.465-.372-1.048-.559-1.633-.476z"/>
    </svg>
  ),
  TikTok: () => (
    <svg viewBox="0 0 24 24" className="social-icon">
