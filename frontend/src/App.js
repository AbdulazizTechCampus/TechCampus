...
const SocialMediaIcons = {
  ...
  Snapchat: () => (
    <svg viewBox="0 0 24 24" className="social-icon">
      ...
      <path fill="white" d="M12.017 2C6.582 2.001 2.17 6.408 2.166 11.845c-.001 1.998.595 3.858 1.632 5.416L2 22l2.906-1.682c1.454.893 3.154 1.368 4.94 1.368 5.435-.004 9.848-4.412 9.852-9.847C19.702 6.403 17.457 2.003 12.017 2zm-4.184 5.123c.328-.143.699-.238 1.097-.238.398 0 .769.095 1.097.238.267.116.426.384.426.681a.688.688 0 01-.687.688.707.707 0 01-.456-.171c-.173-.147-.396-.224-.626-.224s-.453.077-.626.224a.707.707 0 01-.456.171.688.688 0 01-.687-.688c0-.297.159-.565.418-.681zM18 12c0 3.309-2.691 6-6 6s-6-2.691-6-6 2.691-6 6-6 6 2.691 6 6z"/>
      <path fill="#FFFC00" d="M12 8c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4z"/>
      <path fill="white" d="M12 14.5c-1.381 0-2.5-1.119-2.5-2.5s1.119-2.5 2.5-2.5 2.5 1.119 2.5 2.5-1.119 2.5-2.5 2.5z"/>
    </svg>
  ),
  TikTok: () => (
    <svg viewBox="0 0 24 24" className="social-icon">
